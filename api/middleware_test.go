...
func TestAuthMiddleware(t *testing.T) {
	testCases := []struct {
		...
		checkerRequest func(t *testing.T, request *httptest.ResponseRecorder)
	}{
		{
			name: "OK",
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
			...
			checkerRequest: func(t *testing.T, recorder *httptest.ResponseRecorder) {
